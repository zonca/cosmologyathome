...
!Comment these out to try to avoid intel bugs with status deallocating uninitialized pointers   
       ...
       subroutine CAMB_GetResults(Params, error)
        ...
        ! -- BOINC addition
        ! Lower and upper bounds on BOINC progress bar
        real(8) :: lower, upper
        ! --
